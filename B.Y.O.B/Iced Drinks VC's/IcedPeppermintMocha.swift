...
class IcedPeppermintMocha: UIViewController {
    
    let titleLabel: UILabel = {
        let label = UILabel()
        
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Iced Peppermint Mocha"
    ...
    let askFor1: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "1️⃣ Grande Iced coffee /               Cold Brew /                                        Decaf Iced Americano"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor2: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "2️⃣  for it unsweetened"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor3: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "3️⃣ TWO pumps of sugar free     vanilla syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor4: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "4️⃣ ONE pump of peppermint      syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor5: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "5️⃣ ONE pump of mocha syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor6: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "6️⃣ LIGHT Cream (can substitue for non dairy)"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    func setupScrollView() {
        ...
        askFor1.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.135).isActive = true
        ...
        askFor3.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.095).isActive = true
        ...
        askFor4.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.095).isActive = true
        ...
        askFor6.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        askFor6.topAnchor.constraint(equalTo: askFor5.bottomAnchor, constant: view.frame.height * 0.05).isActive = true
        askFor6.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.95).isActive = true
        askFor6.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.095).isActive = true
        askFor6.font = UIFont.boldSystemFont(ofSize: view.frame.width * 0.065)
    }
