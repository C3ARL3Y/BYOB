...
class BlackAndWhiteMocha: UIViewController {
    
    let titleLabel: UILabel = {
        let label = UILabel()
        
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Black And White Mocha"
    ...
    let askFor3: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "3️⃣ ONE pump of white mocha"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor4: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "4️⃣ HALF a pump of mohca"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor5: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "5️⃣ TWO pumps of sugar free      vanilla syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    func setupView() {
        ...
        scrollView.contentSize = CGSize(width: view.frame.width, height: view.frame.height * 1.55)
    ...
    func setupScrollView() {
        ...
        askFor5.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.095).isActive = true
