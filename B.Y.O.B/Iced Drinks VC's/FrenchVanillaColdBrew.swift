...
class FrenchVanillaColdBrew: UIViewController {
    
    let titleLabel: UILabel = {
        let label = UILabel()
        
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "French Vanilla Cold Brew"
    ...
    let askFor2: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "2️⃣ THREE pumps of sugar free vanilla"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor3: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "3️⃣ ONE pump of hazelnut syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor4: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "4️⃣ LIGHT Cream                                (can substitue for non dairy)"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    func setupView() {
        ...
        scrollView.contentSize = CGSize(width: view.frame.width, height: view.frame.height * 1.35)
