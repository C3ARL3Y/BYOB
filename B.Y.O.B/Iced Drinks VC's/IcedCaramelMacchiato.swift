...
class IcedCaramelMacchiato: UIViewController {
    
    let titleLabel: UILabel = {
        let label = UILabel()
        
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Iced Caramel Macchiato"
    ...
    let askFor1: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "1️⃣ Venti Iced coffee /                     Cold Brew /                                        Decaf Iced Americano"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor3: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "3️⃣ ONE pump of caramel syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor4: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "4️⃣ FOUR pumps of sugr free vanilla syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor5: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "5️⃣ LIGHT Cream (can substitue for non dairy)"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor6: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "6️⃣ LIGHT caramel drizzle"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    func setupScrollView() {
        ...
        askFor6.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.05).isActive = true
