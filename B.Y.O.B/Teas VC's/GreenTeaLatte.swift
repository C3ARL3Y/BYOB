...
class GreenTeaLatte: UIViewController {
    
    let titleLabel: UILabel = {
        let label = UILabel()
        
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Green Tea Latte"
    ...
    let askFor1: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "1️⃣ Grande Green Tea Latte"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor2: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "2️⃣ substitue Almond Milk"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor3: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "3️⃣ ONE scoop of matcha"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor4: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "4️⃣ THREE pumps of sugar free vanilla syrup"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
