...
//  B.Y.O.B
//
//  Created by Julian Cearley on 2/15/19.
//  Copyright © 2019 Cearley Software. All rights reserved.
//

import UIKit

class PinkDrink: UIViewController {
    
    let titleLabel: UILabel = {
        let label = UILabel()
        
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Pink Drink"
    ...
    let askFor1: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "1️⃣ Venti Passion Tango Iced Tea"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor3: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "3️⃣ extra strawberry infusion"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor4: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "4️⃣ LIGHT coconut milk"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor5: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "5️⃣ a scoop of strawberries"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
    ...
    let askFor6: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "6️⃣ TWO stevia packets"
        label.textColor = UIColor(red: 52/255, green: 30/255, blue: 21/255, alpha: 1)
        label.textAlignment = .center
        label.lineBreakMode = .byCharWrapping
        label.numberOfLines = 0
